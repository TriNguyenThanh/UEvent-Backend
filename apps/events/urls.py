...
urlpatterns = [
    ...
    path("events/slug/<slug:slug>/", views.PublicEventDetailBySlugView.as_view(), name="public-event-detail-by-slug"),
    path("events/<uuid:pk>/", views.PublicEventDetailView.as_view(), name="public-event-detail"),
    path("events/<uuid:pk>/share-link/", views.PublicEventShareLinkView.as_view(), name="public-event-share-link"),
